...
public class ConferenceContractService extends AContractService {	
	...
	private static Logger log = LoggerFactory.getLogger(ConferenceContractService.class);
	
	@Override
	public String deployContract() throws Exception {
		Credentials credentials = Credentials.create("0x" + privateKey);
		contract = Conference.deploy(web3j, credentials, Web3jConstants.GAS_PRICE, Web3jConstants.GAS_LIMIT_GREETER_TX)
				.sendAsync().get();
		...
		conference = (Conference) contract;
	...
	public boolean buyTicket(String address) throws InterruptedException, ExecutionException {
		return false;
	}
